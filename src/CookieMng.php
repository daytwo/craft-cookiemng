...
class CookieMng extends Plugin
{
    ...
    public function init(): void
    {
        ...
        // Attach plugin event handlers immediately for all request types
    ...
    {
        $env = (object)[
            'cookieEnabled' => (int)Craft::parseEnv('$CM_COOKIE_ENABLED') !== 1 ? false: true,
            ...
            'cookieSecure' => (int)Craft::parseEnv('$CM_COOKIE_SECURE') === '$CM_COOKIE_SECURE' ? false : true,
